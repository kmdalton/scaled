...
Clazz.load (["JU.BS"], "JV.ShapeManager", ["java.lang.Boolean", "JU.P3", "J.api.Interface", "J.constant.EnumPalette", "$.EnumVdw", "JM.Atom", "JW.BSUtil", "JV.JC"], function () {
...
if (d == JM.Atom.MAD_GLOBAL) d = Clazz.floatToInt (this.viewer.getFloat (1141899265) * 2000);
...
JW.BSUtil.invertInPlace (bsSelected, this.viewer.getAtomCount ());
bsSelected.and (bsSubset);
}}JW.BSUtil.andNot (bsSelected, this.viewer.getDeletedAtoms ());
