...
Clazz.load (["java.util.Hashtable"], "JV.StateManager", ["java.util.Arrays", "JU.BS", "$.SB", "JM.Orientation", "JW.BSUtil", "JV.GlobalSettings"], function () {
...
return  new JV.GlobalSettings (this.viewer, gsOld, clearUserVariables);
}, "JV.GlobalSettings,~B");
$_M(c$, "clear", 
function (global) {
...
this.viewer.setIntProperty ("bondingVersion", 0);
...
this.saved.put (saveName, JW.BSUtil.copy (bsSelected));
}, "~S,JU.BS");
...
$_M(c$, "getOrientation", 
function () {
return  new JM.Orientation (this.viewer, false, null);
});
...
return;
}var o =  new JM.Orientation (this.viewer, saveName.equalsIgnoreCase ("default"), pymolView);
...
return (c != null && this.b$["JV.StateManager"].viewer.movePyMOL (this.b$["JV.StateManager"].viewer.eval, a, c));
}, "~N");
c$ = Clazz.p0p ();
};
...
Clazz.makeConstructor (c$, 
function () {
var a = this.b$["JV.StateManager"].viewer.getModelSet ();
if (a == null) return;
...
this.b$["JV.StateManager"].viewer.setShapeProperty (1, "reportAll", null);
return true;
});
c$ = Clazz.p0p ();
};
