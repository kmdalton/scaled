...
Clazz.load (["JU.SB", "$.V3", "JW.Elements", "$.Txt"], "JV.JC", ["java.util.Hashtable", "JU.PT"], function () {
...
c$.getJSVSyncSignal = $_M(c$, "getJSVSyncSignal", 
function (script) {
return (script.length < 7 ? -1 : ("JSPECVIPEAKS: SELECT:").indexOf (script.substring (0, 7).toUpperCase ()));
}, "~S");
...
c$.FORMAL_CHARGE_COLIX_RED = c$.prototype.FORMAL_CHARGE_COLIX_RED = JW.Elements.elementSymbols.length + JV.JC.altArgbsCpk.length;
