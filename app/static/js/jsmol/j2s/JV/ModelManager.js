...
this.modelSetPathName = this.fileName = null;
 new JM.ModelLoader (this.viewer, this.viewer.getZapName (), null, null, null, null);
});
...
} new JM.ModelLoader (this.viewer, modelSetName, loadScript, atomSetCollection, (isAppend ? this.modelSet : null), bsNew);
...
return JM.ModelLoader.createAtomDataSet (this.viewer, this.modelSet, tokType, atomSetCollection, this.viewer.getSelectedAtoms ());
}, "~O,~N");
});
