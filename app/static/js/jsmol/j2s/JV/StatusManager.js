...
Clazz.load (["java.util.Hashtable"], "JV.StatusManager", ["java.lang.Boolean", "$.Float", "javajs.awt.Dimension", "JU.List", "$.PT", "J.api.Interface", "J.constant.EnumCallback", "JW.Logger"], function () {
...
if (this.notifyEnabled (J.constant.EnumCallback.ANIMFRAME)) this.jmolCallbackListener.notifyCallback (J.constant.EnumCallback.ANIMFRAME, [sJmol, [frameNo, fileNo, modelNo, firstNo, lastNo, currentFrame], entryName, Float.$valueOf (currentMorphModel)]);
...
if (isScriptCompletion && this.viewer.getBoolean (603979880) && this.viewer.getBoolean (603979825)) {
...
JW.Logger.debug (this.viewer.appletName + " sync mode=" + syncMode + "; synced? " + this.isSynced + "; driving? " + this.drivingSync + "; disabled? " + this.syncDisabled);
}}, "~N");
$_M(c$, "syncSend", 
