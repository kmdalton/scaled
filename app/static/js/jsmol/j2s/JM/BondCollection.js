...
return  new JM.BondIteratorSelected (this.bonds, this.bondCount, bondType, bsAtoms, this.viewer.getBoolean (603979812));
}, "~N,JU.BS");
$_M(c$, "getBondIterator", 
function (bsBonds) {
return  new JM.BondIteratorSelected (this.bonds, this.bondCount, 131071, bsBonds, false);
}, "JU.BS");
$_M(c$, "getBondAtom1", 
function (i) {
...
if (Clazz.instanceOf (this.bonds[i], JM.HBond)) (this.bonds[i]).energy = energy;
}} else {
...
function (order) {
return (JM.Bond.isOrderH (order) ? 1 : order == 32768 ? Clazz.doubleToInt (Math.floor (this.viewer.getFloat (570425406) * 2000)) : this.defaultCovalentMad);
}, "~N");
