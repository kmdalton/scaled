...
Clazz.load (["java.lang.Short", "java.util.Hashtable", "JV.JC"], "JM.Group", ["java.lang.Float", "JU.AU", "$.BS", "$.P3", "$.Quat", "$.V3", "J.constant.EnumStructure", "JW.BSUtil", "$.Logger"], function () {
...
$_M(c$, "getGroup1", 
function () {
if (this.groupID >= JV.JC.predefinedGroup1Names.length) return '?';
return JV.JC.predefinedGroup1Names[this.groupID];
});
$_M(c$, "getGroupID", 
function () {
return this.groupID;
...
if (insCode != ' ' && insCode != '\0') JW.Logger.warn ("unrecognized insertionCode:" + insCode);
insCode = '\0';
...
if (this.bsAdded != null) JW.BSUtil.deleteBits (this.bsAdded, bsDeleted);
}, "~N,JU.BS");
$_M(c$, "getGroupInfo", 
function (igroup) {
...
}, $fz.isPrivate = true, $fz), "JM.Atom,~A");
