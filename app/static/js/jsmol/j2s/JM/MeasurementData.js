...
this.justOneModel = JW.BSUtil.haveCommon (this.viewer.getModelBitSet (this.points.get (0), false), this.viewer.getModelBitSet (this.points.get (1), false));
}this.htMin = htMin;
...
}, $fz.isPrivate = true, $fz), "~N,~N,JM.Measurement,~N");
});
