...
Clazz.load (null, "JM.Measurement", ["java.lang.Float", "JU.List", "$.PT", "$.SB", "J.atomdata.RadiusData", "J.constant.EnumVdw", "JM.LabelToken", "JW.Escape", "$.Measure"], function () {
...
return JM.LabelToken.formatLabelMeasure (this.viewer, this, label, value, units);
...
return (atomIndex < 0 ? (withModelIndex ? "modelIndex " + this.getAtom (i).modelIndex + " " : "") + JW.Escape.eP (this.getAtom (i)) : asBitSet ? "(({" + atomIndex + "}))" : this.viewer.getAtomInfo (atomIndex));
}, "~N,~B,~B");
$_M(c$, "setModelIndex", 
function (modelIndex) {
