...
Clazz.load (["JU.BS", "$.SB"], "JM.Model", ["java.util.Hashtable", "JU.AU", "JW.BSUtil"], function () {
...
JW.BSUtil.deleteBits (this.bsAtoms, bsDeleted);
JW.BSUtil.deleteBits (this.bsAtomsDeleted, bsDeleted);
}, "~N,~N,JU.BS");
$_M(c$, "freeze", 
function () {
this.freezeM ();
