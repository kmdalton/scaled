...
Clazz.load (null, "JW.Eigen", ["JU.V3"], function () {
...
c$.newM = $_M(c$, "newM", 
function (m) {
var e =  new JW.Eigen ().set (m.length);
e.calc (m);
return e;
}, "~A");
c$.getUnitVectors = $_M(c$, "getUnitVectors", 
function (m, eigenVectors, eigenValues) {
JW.Eigen.newM (m).fillArrays (eigenVectors, eigenValues);
}, "~A,~A,~A");
$_M(c$, "fillArrays", 
