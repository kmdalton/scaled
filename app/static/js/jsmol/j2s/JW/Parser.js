...
Clazz.load (null, "JW.Parser", ["java.lang.Float", "JU.PT"], function () {
c$ = Clazz.declareType (JW, "Parser");
c$.parseStringInfestedFloatArray = $_M(c$, "parseStringInfestedFloatArray", 
function (str, bs, data) {
return JW.Parser.parseFloatArrayBsData (JU.PT.getTokens (str), bs, data);
}, "~S,JU.BS,~A");
...
var lines = JW.Parser.markLines (str, (str.indexOf ('\n') >= 0 ? '\n' : ';'));
