...
this.entryCount = 0;
this.entries = null;
if (!Clazz.isClassDefined ("JW.Int2IntHash.Entry")) {
JW.Int2IntHash.$Int2IntHash$Entry$ ();
}
...
entries[hash] = Clazz.innerTypeInstance (JW.Int2IntHash.Entry, this, null, key, value, entries[hash]);
++this.entryCount;
}, "~N,~N");
$_M(c$, "rehash", 
($fz = function () {
...
this.next = null;
Clazz.instantialize (this, arguments);
}, JW.Int2IntHash, "Entry");
Clazz.makeConstructor (c$, 
function (a, b, c) {
this.key = a;
this.value = b;
this.next = c;
}, "~N,~N,JW.Int2IntHash.Entry");
c$ = Clazz.p0p ();
};
