...
Clazz.load (["J.api.JmolModulationSet", "JW.Vibration", "JU.P3"], "JW.ModulationSet", ["java.lang.Float", "java.util.Hashtable", "JU.List", "$.Matrix", "JW.Escape", "$.Logger"], function () {
...
}, JW, "ModulationSet", JW.Vibration, J.api.JmolModulationSet);
...
function () {
Clazz.superConstructor (this, JW.ModulationSet, []);
});
$_M(c$, "set", 
...
if (JW.Logger.debuggingHigh) JW.Logger.debug ("MODSET create r=" + JW.Escape.eP (r) + " si=" + JW.Escape.e (this.sI.getArray ()) + " ginv=" + this.gammaIinv.toString ().$replace ('\n', ' '));
...
if (JW.Logger.debuggingHigh) JW.Logger.debug ("MODSET " + this.id + " utens=" + utens + " f=" + f + " v=" + v);
...
function () {
var s = "";
if (this.qtOffset != null && this.qtOffset.length () > 0) s += "; modulation " + JW.Escape.eP (this.qtOffset) + " " + this.isQ + ";\n";
...
this.modTemp =  new JW.ModulationSet ();
