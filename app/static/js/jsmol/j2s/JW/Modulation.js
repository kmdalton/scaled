...
Clazz.load (null, "JW.Modulation", ["java.lang.Float", "java.util.Hashtable", "JW.Escape", "$.Logger"], function () {
...
if (JW.Logger.debuggingHigh) JW.Logger.debug ("MOD create " + JW.Escape.e (qCoefs) + " axis=" + axis + " type=" + type + " params=" + JW.Escape.e (params) + " utens=" + utens);
this.axis = axis;
this.type = type;
this.utens = utens;
this.params = params;
...
if (JW.Logger.debuggingHigh) JW.Logger.debug ("MOD " + ms.id + " " + JW.Escape.e (this.qCoefs) + " axis=" + this.axis + " v=" + v + " ccos,csin=" + this.a1 + "," + this.a2 + " / theta=" + theta);
break;
case 'c':
nt -= Math.floor (nt);
