...
Clazz.load (["JU.BS"], "JW.BSUtil", null, function () {
c$ = Clazz.declareType (JW, "BSUtil");
...
function (bs, n) {
return (bs == null ? null : JW.BSUtil.andNot (JW.BSUtil.setAll (n), bs));
}, "JU.BS,~N");
c$.invertInPlace = $_M(c$, "invertInPlace", 
function (bs, n) {
return JW.BSUtil.copy2 (JW.BSUtil.copyInvert (bs, n), bs);
}, "JU.BS,~N");
c$.toggleInPlace = $_M(c$, "toggleInPlace", 
function (a, b) {
if (a.equals (b)) {
a.clearAll ();
} else if (JW.BSUtil.andNot (JW.BSUtil.copy (b), a).length () == 0) {
JW.BSUtil.andNot (a, b);
} else {
a.or (b);
}return a;
}, "JU.BS,JU.BS");
