...
Clazz.load (null, "JW.Tensor", ["java.lang.Float", "java.util.Arrays", "$.Hashtable", "JU.M3", "$.P3", "$.PT", "$.Quat", "$.V3", "JW.Eigen", "$.EigenSort", "$.Escape"], function () {
...
function (infoType) {
switch (JW.Tensor.getInfoIndex (infoType)) {
default:
return false;
case 5:
case 6:
...
this.eigenValues =  Clazz.newFloatArray (3, 0);
this.eigenVectors =  new Array (3);
this.id = (id == null ? "coefs=" + JW.Escape.eAD (coefs) : id);
...
JW.Eigen.getUnitVectors (mat, this.eigenVectors, this.eigenValues);
this.setType ("adp");
this.sortAndNormalize ();
return this;
}, "~A,~S");
...
this.typeFactor = 1;
this.sortIso = false;
switch (this.iType = JW.Tensor.getType (this.type)) {
case 0:
...
case 1:
this.forThermalEllipsoid = true;
this.typeFactor = JW.Tensor.ADP_FACTOR;
this.altType = "1";
break;
case 4:
this.sortIso = true;
...
java.util.Arrays.sort (o, JW.Tensor.getEigenSort ());
for (var i = 0; i < 3; i++) {
var pt = i;
...
($fz = function () {
return (JW.Tensor.tSort == null ? (JW.Tensor.tSort =  new JW.EigenSort ()) : JW.Tensor.tSort);
}, $fz.isPrivate = true, $fz));
$_V(c$, "toString", 
function () {
