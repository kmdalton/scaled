...
Clazz.load (null, "JW.TempArray", ["java.lang.Boolean", "$.Float", "JU.P3", "$.P3i"], function () {
...
function (size) {
var tempPoints;
var iFit = JW.TempArray.findBestFit (size, this.lengthsFreePoints);
if (iFit > 0) {
...
var iFree = JW.TempArray.findShorter (tempPoints.length, this.lengthsFreePoints);
...
function (size) {
var tempScreens;
var iFit = JW.TempArray.findBestFit (size, this.lengthsFreeScreens);
if (iFit > 0) {
...
var iFree = JW.TempArray.findShorter (tempScreens.length, this.lengthsFreeScreens);
if (iFree >= 0) this.freeScreens[iFree] = tempScreens;
}, "~A");
$_M(c$, "allocTempEnum", 
function (size) {
var tempEnum;
var iFit = JW.TempArray.findBestFit (size, this.lengthsFreeEnum);
if (iFit > 0) {
...
var iFree = JW.TempArray.findShorter (tempEnum.length, this.lengthsFreeEnum);
