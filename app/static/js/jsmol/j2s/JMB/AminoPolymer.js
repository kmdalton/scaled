...
Clazz.load (["JMB.AlphaPolymer"], "JMB.AminoPolymer", ["JU.P3", "$.V3", "J.constant.EnumStructure", "JM.HBond", "JW.Logger", "$.Measure"], function () {
c$ = Clazz.decorateAsClass (function () {
this.structureList = null;
Clazz.instantialize (this, arguments);
}, JMB, "AminoPolymer", JMB.AlphaPolymer);
Clazz.makeConstructor (c$, 
function (monomers) {
Clazz.superConstructor (this, JMB.AminoPolymer, [monomers]);
this.type = 1;
...
residue2.setGroupParameter (1112539145, JW.Measure.computeTorsion (carbon1, nitrogen2, alphacarbon2, carbon2, true));
residue1.setGroupParameter (1112539146, JW.Measure.computeTorsion (nitrogen1, alphacarbon1, carbon1, nitrogen2, true));
residue1.setGroupParameter (1112539144, JW.Measure.computeTorsion (alphacarbon1, carbon1, nitrogen2, alphacarbon2, true));
}, $fz.isPrivate = true, $fz), "JMB.AminoMonomer,JMB.AminoMonomer");
...
if (!(Clazz.instanceOf (polymer, JMB.AminoPolymer))) return;
var pt =  new JU.P3 ();
var vNH =  new JU.V3 ();
var source;
...
}, $fz.isPrivate = true, $fz), "JMB.AminoMonomer,JMB.BioPolymer,~N,JU.P3,JU.BS,JU.List,~A,~B");
...
}, $fz.isPrivate = true, $fz), "JU.P3,JU.P3,JMB.AminoMonomer,~B");
...
}, $fz.isPrivate = true, $fz), "JM.Atom,JM.Atom,~N,~N,~N,JU.List");
...
structureTags[i] = 'n';
}if (JW.Logger.debugging) JW.Logger.debug ((0 + this.monomers[0].getChainID ()) + " aminopolymer:" + i + " " + trailingResidue.getGroupParameter (1112539145) + "," + leadingResidue.getGroupParameter (1112539146) + " " + structureTags[i]);
}
...
$_M(c$, "isTurn", 
($fz = function (psi, phi) {
return JMB.AminoPolymer.checkPhiPsi (this.structureList.get (J.constant.EnumStructure.TURN), psi, phi);
}, $fz.isPrivate = true, $fz), "~N,~N");
$_M(c$, "isSheet", 
($fz = function (psi, phi) {
return JMB.AminoPolymer.checkPhiPsi (this.structureList.get (J.constant.EnumStructure.SHEET), psi, phi);
}, $fz.isPrivate = true, $fz), "~N,~N");
$_M(c$, "isHelix", 
($fz = function (psi, phi) {
return JMB.AminoPolymer.checkPhiPsi (this.structureList.get (J.constant.EnumStructure.HELIX), psi, phi);
}, $fz.isPrivate = true, $fz), "~N,~N");
