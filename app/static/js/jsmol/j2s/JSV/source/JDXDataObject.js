...
Clazz.load (["JSV.source.JDXHeader"], "JSV.source.JDXDataObject", ["java.lang.Character", "$.Double", "JU.DF", "$.PT", "JSV.common.Annotation", "$.Coordinate", "$.Integral", "JSV.exception.JSVException", "JW.Logger"], function () {
...
JW.Logger.info ("Freq for " + nuc + " = " + freq);
}, "~S,~B");
$_M(c$, "fixNucleus", 
($fz = function (nuc) {
...
JW.Logger.info ("Y values have been scaled by a factor of " + this.normalizationFactor);
}, "~N");
$_M(c$, "getDeltaX", 
function () {
