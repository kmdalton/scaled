...
this.nSpectra++;
}, $fz.isPrivate = true, $fz), "JSV.common.Spectrum");
$_M(c$, "splitStack", 
...
}, $fz.isPrivate = true, $fz), "JSV.common.Spectrum,~N,~N");
...
if (doAll) {
this.drawSpectrum (gMain, i, offset, isGrey, ig, isContinuous);
...
}, $fz.isPrivate = true, $fz), "~O,JSV.common.Spectrum,~N,JSV.common.IntegralData");
$_M(c$, "setScale", 
function (i) {
...
}}, $fz.isPrivate = true, $fz), "~O,~O,JSV.common.Spectrum");
$_M(c$, "drawPeak", 
($fz = function (g, pi, tickSize) {
if (this.pd.isPrinting) return;
var xMin = pi.getXMin ();
var xMax = pi.getXMax ();
if (xMin == xMax) return;
this.drawBar (g, pi, xMin, xMax, null, tickSize);
}, $fz.isPrivate = true, $fz), "~O,JSV.common.PeakInfo,~N");
$_M(c$, "drawWidgets", 
...
$_M(c$, "drawBar", 
($fz = function (g, pi, xMin, xMax, whatColor, tickSize) {
var r = xMax + xMin;
...
}}}, $fz.isPrivate = true, $fz), "~O,JSV.common.PeakInfo,~N,~N,JSV.common.ScriptToken,~N");
$_M(c$, "drawSpectrum", 
($fz = function (g, index, yOffset, isGrey, ig, isContinuous) {
var spec = this.spectra.get (index);
this.drawPlot (g, index, spec.getXYCoords (), isContinuous, yOffset, isGrey, null);
if (ig != null) {
...
}, $fz.isPrivate = true, $fz), "~O,~N,~N,~B,JSV.common.IntegralData,~B");
...
}, $fz.isPrivate = true, $fz), "~O,JSV.common.Spectrum,JSV.common.PeakData");
...
return null;
}, $fz.isPrivate = true, $fz), "JU.List,JSV.common.Spectrum");
