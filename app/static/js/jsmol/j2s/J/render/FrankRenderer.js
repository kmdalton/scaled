...
Clazz.load (["J.render.ShapeRenderer"], "J.render.FrankRenderer", ["JW.C"], function () {
...
if (!this.g3d.setColix (JW.C.getColixTranslucent3 (this.colix, this.g3d.haveTranslucentObjects (), 0.5))) return true;
