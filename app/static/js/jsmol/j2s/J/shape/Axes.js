...
Clazz.load (["J.shape.FontLineShape", "JU.P3", "$.V3"], "J.shape.Axes", ["java.lang.Boolean", "JU.PT", "$.SB", "J.constant.EnumAxesMode", "JW.Escape", "JV.JC"], function () {
...
if (this.fixedOrigin != null) sb.append ("  axes center ").append (JW.Escape.eP (this.fixedOrigin)).append (";\n");
