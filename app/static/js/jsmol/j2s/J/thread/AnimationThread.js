...
break;
case 0:
if (!this.animationManager.animationOn || this.checkInterrupted (this.animationManager.animationThread)) {
mode = -2;
break;
...
break;
case 3:
while (this.animationManager.animationOn && !this.checkInterrupted (this.animationManager.animationThread) && !this.viewer.getRefreshing ()) {
