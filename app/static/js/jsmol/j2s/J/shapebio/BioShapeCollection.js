...
Clazz.load (["J.shape.Shape"], "J.shapebio.BioShapeCollection", ["JU.AU", "J.constant.EnumPalette", "J.shapebio.BioShape", "JW.BSUtil", "$.C"], function () {
...
var twoColors = value;
var colixBack = JW.C.getColixO (twoColors[0]);
var colix = JW.C.getColixO (twoColors[1]);
for (var i = this.bioShapes.length; --i >= 0; ) {
var bioShape = this.bioShapes[i];
