...
Clazz.load (["JU.M4"], "J.symmetry.HallRotationTerm", ["JU.SB", "J.symmetry.HallRotation", "$.HallTranslation", "$.SymmetryOperation", "JW.Logger"], function () {
...
JW.Logger.error ("Rotation lookup could not find " + this.inputCode + " ? " + this.lookupCode);
return;
...
JW.Logger.debug ("code = " + code + "; primitive code =" + this.primitiveCode + "\n Seitz Matrix(12ths):" + this.seitzMatrix12ths);
