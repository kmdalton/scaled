...
Clazz.load (["java.util.Hashtable"], "J.symmetry.SpaceGroup", ["java.lang.Character", "java.util.Arrays", "JU.AU", "$.List", "$.M4", "$.P3", "$.PT", "$.SB", "J.symmetry.HallInfo", "$.HallTranslation", "$.SymmetryOperation", "JW.Logger"], function () {
...
JW.Logger.error ("couldn't interpret symmetry operation: " + xyz0);
return -1;
...
if (this.latticeOp < 0 && this.xyzList.containsKey (JU.PT.rep (xyz, "+1/2", ""))) this.latticeOp = this.operationCount;
