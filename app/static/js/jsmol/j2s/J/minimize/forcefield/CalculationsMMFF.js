...
Clazz.load (["J.minimize.forcefield.Calculation", "$.Calculations"], "J.minimize.forcefield.CalculationsMMFF", ["JU.List", "J.minimize.MinAtom", "$.MinObject", "JW.Txt"], function () {
...
var h = e[1];
var i = f[1];
a.addLast ([b.data, [c[0], g, h], b.sbKey]);
a.addLast ([[b.data[2], b.data[1], b.data[0]], [c[1], g, i], b.sbKey]);
}, "JU.List,J.minimize.MinAngle");
$_V(c$, "compute", 
function (a) {
this.key = a[2];
