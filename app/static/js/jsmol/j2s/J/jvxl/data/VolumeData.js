...
Clazz.load (["J.api.VolumeDataInterface", "JU.M3", "$.P3", "$.V3"], "J.jvxl.data.VolumeData", ["java.lang.Float", "java.util.Hashtable", "JU.SB", "J.io.XmlUtil", "JW.Escape", "$.Logger"], function () {
...
J.io.XmlUtil.openTagAttr (sb, "jvxlVolumeData", ["origin", JW.Escape.eP (this.volumetricOrigin)]);
for (var i = 0; i < 3; i++) J.io.XmlUtil.appendTag (sb, "jvxlVolumeVector", ["type", "" + i, "count", "" + this.voxelCounts[i], "vector", JW.Escape.eP (this.volumetricVectors[i])]);
