...
Clazz.load (["J.jvxl.readers.AtomDataReader"], "J.jvxl.readers.IsoMOReader", ["java.lang.Float", "java.util.Random", "JU.AU", "$.P3", "$.V3", "J.api.Interface", "J.constant.EnumQuantumShell", "JW.Logger", "$.Measure", "$.Txt"], function () {
...
if (line.indexOf ("%I") >= 0) line = JW.Txt.formatStringS (line, "I", this.params.qm_moLinearCombination == null ? "" + this.params.qm_moNumber : J.constant.EnumQuantumShell.getMOString (this.params.qm_moLinearCombination));
