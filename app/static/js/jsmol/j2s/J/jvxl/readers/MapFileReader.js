...
Clazz.load (["J.jvxl.readers.VolumeFileReader", "JU.P3"], "J.jvxl.readers.MapFileReader", ["JW.Logger", "$.SimpleUnitCell"], function () {
...
function () {
JW.Logger.info ("grid parameters: nx,ny,nz: " + this.nx + "," + this.ny + "," + this.nz);
JW.Logger.info ("grid parameters: nxStart,nyStart,nzStart: " + this.nxyzStart[0] + "," + this.nxyzStart[1] + "," + this.nxyzStart[2]);
JW.Logger.info ("grid parameters: mx,my,mz: " + this.na + "," + this.nb + "," + this.nc);
JW.Logger.info ("grid parameters: a,b,c,alpha,beta,gamma: " + this.a + "," + this.b + "," + this.c + "," + this.alpha + "," + this.beta + "," + this.gamma);
JW.Logger.info ("grid parameters: mapc,mapr,maps: " + this.mapc + "," + this.mapr + "," + this.maps);
JW.Logger.info ("grid parameters: originX,Y,Z: " + this.origin);
var unitCell = JW.SimpleUnitCell.newA ([this.a / this.na, this.b / this.nb, this.c / this.nc, this.alpha, this.beta, this.gamma]);
...
JW.Logger.info ("Jmol unit cell vectors:");
JW.Logger.info ("    a: " + this.vectors[0]);
JW.Logger.info ("    b: " + this.vectors[1]);
JW.Logger.info ("    c: " + this.vectors[2]);
...
JW.Logger.info ("Jmol grid origin in Cartesian coordinates: " + this.origin);
JW.Logger.info ("Use  isosurface OFFSET {x y z}  if you want to shift it.\n");
});
