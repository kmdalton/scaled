...
Clazz.load (["J.api.JmolParallelProcessor", "J.script.ScriptFunction", "JU.List"], "J.parallel.ScriptParallelProcessor", ["java.util.concurrent.Executors", "J.parallel.ScriptProcess", "$.ScriptProcessRunnable", "JW.Logger", "JV.ShapeManager", "$.Viewer"], function () {
...
if (inParallel) {
shapeManager =  new JV.ShapeManager (viewer, viewer.getModelSet ());
...
r.run ();
}}, $fz.isPrivate = true, $fz), "J.parallel.ScriptProcess,JV.ShapeManager");
$_M(c$, "eval", 
