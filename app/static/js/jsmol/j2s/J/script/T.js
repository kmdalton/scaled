...
$_M(c$, "toString2", 
function () {
return "Token[" + J.script.T.astrType[this.tok < 15 ? this.tok : 15] + "(" + (this.tok % (512)) + "/0x" + Integer.toHexString (this.tok) + ")" + ((this.intValue == 2147483647) ? "" : " intValue=" + this.intValue + "(0x" + Integer.toHexString (this.intValue) + ")") + ((this.value == null) ? "" : Clazz.instanceOf (this.value, String) ? " value=\"" + this.value + "\"" : " value=" + this.value) + "]";
});
...
"context", 14,
"keyword", 15,
"astrType", ["nada", "identifier", "integer", "decimal", "string", "seqcode", "hash", "array", "point", "point4", "bitset", "matrix3f", "matrix4f", "array", "hash", "keyword"],
"setparam", (536870912),
"misc", (1073741824),
