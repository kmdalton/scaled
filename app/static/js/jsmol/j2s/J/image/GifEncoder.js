...
Clazz.load (["JU.List", "J.image.ImageEncoder"], "J.image.GifEncoder", ["java.lang.Boolean", "java.util.Collections", "$.Hashtable", "JW.Logger"], function () {
...
ciHash = null;
if (JW.Logger.debugging) JW.Logger.debug ("# total image colors = " + nColors);
colorVector.sort ();
return colorVector;
}, $fz.isPrivate = true, $fz));
$_M(c$, "getBest256", 
...
if (JW.Logger.debugging) JW.Logger.debug ("# GIF colors = " + ht.size ());
return ht;
