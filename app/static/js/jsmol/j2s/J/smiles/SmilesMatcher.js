...
Clazz.load (["J.api.SmilesMatcherInterface"], "J.smiles.SmilesMatcher", ["JU.AU", "$.BS", "$.PT", "J.smiles.InvalidSmilesException", "$.SmilesGenerator", "$.SmilesParser", "JW.BSUtil"], function () {
...
var bs = JW.BSUtil.copy (search.search (false));
ret.addLast (bs);
bsDone.or (bs);
