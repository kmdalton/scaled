...
Clazz.load (["J.shape.Shape", "java.util.Hashtable"], "J.shapespecial.Ellipsoids", ["JU.BS", "$.PT", "$.SB", "$.V3", "J.constant.EnumPalette", "J.shapespecial.Ellipsoid", "JW.BSUtil", "$.C", "$.Escape"], function () {
...
this.ellipsoidSelected.colix = JW.C.getColixO (value);
return;
...
this.ellipsoidSelected.colix = JW.C.getColixTranslucent3 (this.ellipsoidSelected.colix, isTranslucent, this.translucentLevel);
return;
