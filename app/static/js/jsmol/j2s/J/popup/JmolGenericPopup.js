...
Clazz.load (["J.popup.GenericSwingPopup", "java.util.Properties", "JU.List"], "J.popup.JmolGenericPopup", ["java.lang.Boolean", "java.util.Hashtable", "JU.PT", "J.i18n.GT", "J.popup.MainPopupResourceBundle", "JW.Elements", "JV.JC"], function () {
...
var elementName = JW.Elements.elementNameFromNumber (i);
var elementSymbol = JW.Elements.elementSymbolFromNumber (i);
var entryName = elementSymbol + " - " + elementName;
this.menuCreateItem (menu, entryName, "SELECT " + elementName, null);
}
for (var i = 4; i < JW.Elements.altElementMax; ++i) {
var n = JW.Elements.elementNumberMax + i;
if (elementsPresentBitSet.get (n)) {
n = JW.Elements.altElementNumberFromIndex (i);
var elementName = JW.Elements.elementNameFromNumber (n);
var elementSymbol = JW.Elements.elementSymbolFromNumber (n);
var entryName = elementSymbol + " - " + elementName;
this.menuCreateItem (menu, entryName, "SELECT " + elementName, null);
}}
this.menuEnable (menu, true);
