...
Clazz.load (null, "J.io.JmolBinary", ["java.io.BufferedInputStream", "$.BufferedReader", "$.ByteArrayInputStream", "$.InputStreamReader", "$.StringReader", "JU.AU", "$.Base64", "$.Encoding", "$.PT", "$.SB", "J.api.Interface", "J.io.LimitedLineReader", "JW.Logger", "JV.FileManager"], function () {
...
($fz = function () {
return (J.io.JmolBinary.jzu == null ? J.io.JmolBinary.jzu = J.api.Interface.getOption ("io2.ZipUtil") : J.io.JmolBinary.jzu);
