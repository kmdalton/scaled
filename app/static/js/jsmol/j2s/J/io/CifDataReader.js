...
Clazz.load (["JU.SB"], "J.io.CifDataReader", ["java.util.Hashtable", "JU.List", "JW.Logger"], function () {
...
JW.Logger.warn ("CIF ERROR ? should be an underscore: " + key);
} else {
var value = this.getNextToken ();
if (value == null) {
JW.Logger.warn ("CIF ERROR ? end of file; data missing: " + key);
} else {
