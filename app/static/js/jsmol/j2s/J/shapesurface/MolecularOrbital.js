...
Clazz.load (["J.shapesurface.Isosurface"], "J.shapesurface.MolecularOrbital", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.AU", "$.List", "$.PT", "$.SB", "J.constant.EnumQuantumShell", "J.jvxl.data.JvxlCoder", "JW.Escape"], function () {
...
if (this.moColorNeg != null) J.shape.Shape.appendCmd (s, "mo color " + JW.Escape.escapeColor (this.moColorNeg.intValue ()) + (this.moColorNeg.equals (this.moColorPos) ? "" : " " + JW.Escape.escapeColor (this.moColorPos.intValue ())));
if (this.moSlab != null) {
