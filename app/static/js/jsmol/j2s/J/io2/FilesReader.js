...
Clazz.load (["J.api.JmolFilesReaderInterface"], "J.io2.FilesReader", ["java.io.BufferedInputStream", "$.BufferedReader", "java.util.zip.ZipInputStream", "JU.PT", "J.api.Interface", "$.JmolDocument", "J.io.JmolBinary", "JW.Logger"], function () {
...
JW.Logger.error ("file ERROR: " + this.atomSetCollection);
return;
}if (!this.isAppend && !this.viewer.displayLoadErrors) this.viewer.zap (false, true, false);
...
var jd = J.api.Interface.getOption ("io2.BinaryDocument");
jd.setStream (t, true);
return jd;
