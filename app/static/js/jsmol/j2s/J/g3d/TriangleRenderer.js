...
Clazz.load (["J.g3d.G3DRenderer", "JW.Rgb16"], "J.g3d.TriangleRenderer", ["JW.GData"], function () {
...
this.rgb16t1 =  new JW.Rgb16 ();
this.rgb16t2 =  new JW.Rgb16 ();
});
...
for (var i = 64; --i >= 0; ) {
this.rgb16sW[i] =  new JW.Rgb16 ();
this.rgb16sE[i] =  new JW.Rgb16 ();
}
this.g3d = g3d;
this.rgb16sGouraud =  new Array (3);
for (var i = 3; --i >= 0; ) this.rgb16sGouraud[i] =  new JW.Rgb16 ();
...
for (var i = rgb16s.length; i < n; ++i) t[i] =  new JW.Rgb16 ();
...
var roundFactor;
roundFactor = JW.GData.roundInt (Clazz.doubleToInt (nLines / 2));
...
var roundingFactor = JW.GData.roundInt (Clazz.doubleToInt (dy / 2));
...
xMajorIncrement = JW.GData.roundInt (Clazz.doubleToInt (dx / dy));
