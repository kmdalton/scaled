...
Clazz.load (["J.api.JmolRendererInterface", "JW.GData", "JU.V3", "JW.Normix"], "J.g3d.Graphics3D", ["java.lang.NullPointerException", "java.util.Arrays", "javajs.awt.Font", "JU.AU", "J.api.Interface", "J.constant.EnumStereoMode", "J.g3d.CylinderRenderer", "$.ImageRenderer", "$.LineRenderer", "$.Pixelator", "$.PixelatorShaded", "$.Platform3D", "$.SphereRenderer", "$.TextRenderer", "$.TextSorter", "$.TextString", "JW.C", "$.Shader"], function () {
...
}, J.g3d, "Graphics3D", JW.GData, J.api.JmolRendererInterface);
...
$_V(c$, "setColix", 
function (colix) {
var isLast = JW.C.isColixLastAvailable (colix);
...
t.setText (str, font3d == null ? this.currentFont : (this.currentFont = font3d), this.argbCurrent, JW.C.isColixTranslucent (bgColix) ? (this.getColorArgbOrGray (bgColix) & 0xFFFFFF) | ((bgColix & 30720) << 13) : 0, xBaseline, yBaseline, z);
...
maskB &= -16385;
maskC &= -16385;
var mask = JW.GData.roundInt (Clazz.doubleToInt ((maskA + maskB + maskC) / 3)) & 30720;
this.translucencyMask = (mask << 13) | 0xFFFFFF;
return true;
...
var zIncrementScaled = JW.GData.roundInt (Clazz.doubleToInt (((dz << 10) + (dz >= 0 ? roundFactor : -roundFactor)) / count));
if (x < 0) {
x = -x;
...
var rScaled = rgb16Left.r << 8;
var rIncrement = JW.GData.roundInt (Clazz.doubleToInt (((rgb16Right.r - rgb16Left.r) << 8) / count));
var gScaled = rgb16Left.g;
var gIncrement = JW.GData.roundInt (Clazz.doubleToInt ((rgb16Right.g - gScaled) / count));
var bScaled = rgb16Left.b;
var bIncrement = JW.GData.roundInt (Clazz.doubleToInt ((rgb16Right.b - bScaled) / count));
while (--count >= 0) {
if (this.addAllPixels || (flipflop = !flipflop)) {
var z = zScaled >> 10;
...
this.argbNoisyUp = this.shadesCurrent[shadeIndex < JW.Shader.shadeIndexLast ? shadeIndex + 1 : JW.Shader.shadeIndexLast];
...
}if (shadeIndex > JW.Shader.shadeIndexNoisyLimit) shadeIndex = JW.Shader.shadeIndexNoisyLimit;
this.setColorNoisy (shadeIndex);
...
var vertexVectors = JW.Normix.getVertexVectors ();
...
"sort", null);
c$.normixCount = c$.prototype.normixCount = JW.Normix.getNormixCount ();
Clazz.defineStatics (c$,
"nullShadeIndex", 50);
});
