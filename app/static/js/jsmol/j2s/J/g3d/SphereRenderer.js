...
Clazz.load (["JU.P3", "JW.Shader"], "J.g3d.SphereRenderer", ["JW.GData"], function () {
...
var thisOctant = JW.GData.getScreenOctant (this.ptTemp);
...
c$.SHADE_SLAB_CLIPPED = c$.prototype.SHADE_SLAB_CLIPPED = JW.Shader.shadeIndexNormal - 5;
});
