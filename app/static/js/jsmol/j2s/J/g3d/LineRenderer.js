...
Clazz.load (["java.util.Hashtable"], "J.g3d.LineRenderer", ["java.lang.Float", "JU.BS", "JW.Logger", "$.Shader"], function () {
...
this.nFound++;
if (this.nFound == 1000000) JW.Logger.debug ("nCached/nFound lines: " + this.nCached + " " + this.nFound);
}return true;
...
var offsetMax = this.g3d.bufferSize;
var shadeIndexUp = (shadeIndex < JW.Shader.shadeIndexLast ? shadeIndex + 1 : shadeIndex);
