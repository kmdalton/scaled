...
Clazz.load (null, "J.adapter.smarter.Resolver", ["java.lang.Character", "$.Float", "java.util.StringTokenizer", "JU.PT", "J.adapter.smarter.AtomSetCollectionReader", "$.SmarterJmolAdapter", "J.api.Interface", "$.JmolDocument", "J.io.LimitedLineReader", "JW.Logger"], function () {
...
if (readerName == null) errMsg = "unrecognized file format type " + type;
 else JW.Logger.info ("The Resolver assumes " + readerName);
} else {
...
if (type != null) readerName = type;
 ...
 else if (!fullName.equals ("ligand")) JW.Logger.info ("The Resolver thinks " + readerName);
}if (errMsg != null) {
...
JW.Logger.debug ("The Resolver thinks " + atomSetCollectionReaderName);
