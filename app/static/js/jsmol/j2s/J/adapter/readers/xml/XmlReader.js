...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.xml.XmlReader", ["java.util.Hashtable", "J.adapter.smarter.AtomSetCollection", "$.Resolver", "J.api.Interface", "JW.Logger"], function () {
...
JW.Logger.error ("applySymmetry failed: " + e);
} else {
throw e;
}
}
