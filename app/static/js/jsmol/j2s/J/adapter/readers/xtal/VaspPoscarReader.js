...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader", "JU.List"], "J.adapter.readers.xtal.VaspPoscarReader", ["JU.SB", "JW.Logger"], function () {
...
var s = mf.toString ();
JW.Logger.info ("VaspPoscar reader: " + this.atomCount + " atoms identified for" + s);
