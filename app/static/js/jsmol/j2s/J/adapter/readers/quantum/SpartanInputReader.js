...
Clazz.load (["J.adapter.readers.quantum.BasisFunctionReader"], "J.adapter.readers.quantum.SpartanInputReader", ["J.adapter.smarter.Bond", "JW.Logger"], function () {
...
if (JW.Logger.debugging) JW.Logger.debug (this.atomCount + " atoms read");
}, $fz.isPrivate = true, $fz));
$_M(c$, "readAtomNames", 
($fz = function () {
...
this.readLine ();
if (JW.Logger.debugging) JW.Logger.debug (this.atomSetCollection.bondCount + " bonds read");
