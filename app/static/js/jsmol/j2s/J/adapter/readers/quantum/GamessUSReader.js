...
Clazz.load (["J.adapter.readers.quantum.GamessReader"], "J.adapter.readers.quantum.GamessUSReader", ["java.lang.Float", "JU.List", "$.V3", "JW.Logger"], function () {
...
$_V(c$, "checkLine", 
function () {
if (this.line.indexOf ("***************") >= 0) JW.Logger.info (this.readLine ());
var isBohr;
