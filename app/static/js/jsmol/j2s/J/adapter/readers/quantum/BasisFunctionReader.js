...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader", "java.util.Hashtable", "JU.List"], "J.adapter.readers.quantum.BasisFunctionReader", ["java.lang.Character", "java.util.Arrays", "J.api.JmolAdapter", "JW.Logger"], function () {
...
if (!isHeader) JW.Logger.info ("filter MOs: " + isOK + " for \"" + this.line + "\"");
return isOK;
});
$_M(c$, "setMO", 
function (mo) {
...
if (!isOK) {
JW.Logger.error ("Disabling orbitals of type " + shellType + " -- Cannot read orbital order for: " + fileList + "\n expecting: " + jmolList);
