...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.xtal.ShelxReader", ["java.lang.Float", "JU.AU", "J.adapter.smarter.Atom", "JW.Logger"], function () {
...
JW.Logger.error ("skipping line " + this.line);
return;
}elementIndex--;
...
JW.Logger.error ("Bad anisotropic Uij data: " + this.line);
return;
}
