...
Clazz.load (["J.adapter.readers.xml.XmlReader"], "J.adapter.readers.xml.XmlVaspReader", ["java.lang.Double", "JU.PT", "$.SB", "$.V3", "JW.Logger"], function () {
...
function (localName) {
if (JW.Logger.debugging) JW.Logger.debug ("xmlvasp: start " + localName);
...
function (localName) {
if (JW.Logger.debugging) JW.Logger.debug ("xmlvasp: end " + localName);
while (true) {
