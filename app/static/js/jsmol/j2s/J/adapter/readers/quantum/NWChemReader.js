...
Clazz.load (["J.adapter.readers.quantum.MOReader", "java.util.Hashtable"], "J.adapter.readers.quantum.NWChemReader", ["java.lang.Character", "$.Float", "JU.AU", "$.List", "J.adapter.readers.quantum.BasisFunctionReader", "J.adapter.smarter.SmarterJmolAdapter", "J.api.JmolAdapter", "JW.Logger"], function () {
...
this.addAtomXYZSymName (tokens, 3, null, name);
...
tokens = this.getTokens ();
this.setAtomCoordScaled (null, tokens, 3, 0.5291772).atomName = this.fixTag (tokens[0]);
}
...
JW.Logger.info (this.gaussianCount + " Gaussians read");
return true;
}, $fz.isPrivate = true, $fz));
$_M(c$, "readMOs", 
($fz = function () {
