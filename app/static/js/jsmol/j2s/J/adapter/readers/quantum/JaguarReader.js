...
Clazz.load (["J.adapter.readers.quantum.MOReader"], "J.adapter.readers.quantum.JaguarReader", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.AU", "$.List", "J.api.JmolAdapter", "JW.Logger"], function () {
...
JW.Logger.debug (sarray.size () + " slater shells read");
