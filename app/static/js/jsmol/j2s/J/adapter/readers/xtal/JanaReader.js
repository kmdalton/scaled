...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.xtal.JanaReader", ["java.lang.Float", "java.util.Hashtable", "JU.BS", "$.List", "$.Matrix", "$.PT", "J.adapter.smarter.Atom", "J.api.Interface", "J.io.JmolBinary", "JW.Logger"], function () {
...
function () {
this.readM40Data ();
if (this.lattvecs != null && this.lattvecs.size () > 0) this.atomSetCollection.getSymmetry ().addLatticeVectors (this.lattvecs);
if (this.ms != null) {
