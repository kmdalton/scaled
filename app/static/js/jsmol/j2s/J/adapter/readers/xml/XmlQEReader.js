...
Clazz.load (["J.adapter.readers.xml.XmlReader"], "J.adapter.readers.xml.XmlQEReader", ["JW.Logger"], function () {
...
function (localName) {
if (JW.Logger.debugging) JW.Logger.debug ("xmlqe: start " + localName);
...
function (localName) {
if (JW.Logger.debugging) JW.Logger.debug ("xmlqe: end " + localName);
while (true) {
