...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader", "java.util.Hashtable", "JU.List", "$.P3", "$.P4", "$.V3"], "J.adapter.readers.simple.ZMatrixReader", ["java.lang.Character", "$.Exception", "$.Float", "JU.Quat", "J.adapter.smarter.Atom", "$.Bond", "J.api.JmolAdapter", "JW.Logger", "$.Measure"], function () {
...
JW.Logger.info ("symbolic " + this.tokens[0] + " = " + f);
}, $fz.isPrivate = true, $fz));
$_M(c$, "getAtom", 
($fz = function () {
var f;
...
JW.Logger.info ("#dummy atom ignored: atom " + this.atomCount + " - " + atom.atomName);
} else {
this.atomSetCollection.addAtom (atom);
this.setAtomCoord (atom);
JW.Logger.info (atom.atomName + " " + atom.x + " " + atom.y + " " + atom.z);
...
JW.Measure.getPlaneThroughPoint (this.setAtom (atom, ia, ib, ic, -d, theta1, 0), this.v1, this.plane1);
JW.Measure.getPlaneThroughPoint (this.setAtom (atom, ia, ic, ib, -d, theta2, 0), this.v1, this.plane2);
var list = JW.Measure.getIntersectionPP (this.plane1, this.plane2);
