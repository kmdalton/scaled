...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.xtal.DmolReader", ["java.lang.Double", "JU.DF", "JW.Logger"], function () {
...
if (JW.Logger.debugging) JW.Logger.debug ((this.vibrationNumber + n) + " frequency=" + frequencies[n]);
}
