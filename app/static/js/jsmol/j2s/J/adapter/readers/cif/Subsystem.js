...
Clazz.load (null, "J.adapter.readers.cif.Subsystem", ["JU.List", "$.Matrix", "$.V3", "J.api.Interface", "JW.Logger"], function () {
...
var a;
JW.Logger.info ("[subsystem " + this.code + "]");
var winv = this.w.inverse ();
JW.Logger.info ("w=" + this.w);
JW.Logger.info ("w_inv=" + winv);
...
JW.Logger.info ("sigma_nu = " + sigma_nu);
...
JW.Logger.info ("unit cell parameters: " + this.symmetry.getUnitCellInfo ());
...
JW.Logger.info (this.code + "." + (iop + 1) + (this.code.equals (code) ? "   " : ">" + code + " ") + jf);
}
